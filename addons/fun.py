...
class Fun:
    ...
    '''
    def __init__(self, bot): # Run when module is loaded
        self.bot = bot
    ...
    async def helix(self, ctx, *question):
        ...
        responses = ['It is certain.','It is decidedly so.','Without a doubt.','Yes, definitely.','You may rely on it.',
                     'As I see it, yes.','Most likely.','Outlook good.','Yes.','Signs point to yes.','It is the choice of Steins Sate!',
                     'Reply hazy, try again.','Ask again later.','Better not tell you now.','Cannont predict now.','Concentrate and ask again.',
